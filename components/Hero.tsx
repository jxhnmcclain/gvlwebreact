      ...
      >
        ...
        <div className="col-span-1 md:col-span-12 lg:col-span-5 flex flex-col justify-center text-left py-8 md:py-0">
          <motion.div variants={itemVariants} className="flex items-center gap-2 mb-6">
            <span className="font-bold text-lg tracking-tight uppercase text-gray-500">GROWTH VIDEO LAB</span>
          </motion.div>
          ...
          <motion.h1 variants={itemVariants} className="text-5xl md:text-6xl lg:text-7xl font-black leading-[1.05] tracking-tighter mb-8 text-black">
            Agencia Creativa de <span className="text-gvl-orange">Contenido</span> y <span className="text-gvl-blue">Video Digital</span>
          </motion.h1>
          ...
          <motion.p variants={itemVariants} className="text-lg md:text-xl font-medium text-gray-600 mb-10 max-w-md leading-relaxed flex items-start gap-4">
            ...
            Producción audiovisual, branding y webs de alto nivel. Contamos historias reales que conectan, posicionan tu marca y escalan tus ventas.
          </motion.p>
        ...
        <div className="col-span-1 md:col-span-12 lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-4 auto-rows-[minmax(240px,auto)]">
          ...
          >
            <div>
              ...
              <h3 className="text-2xl font-black text-white leading-tight mb-6">
                Creación y distribución <span className="text-gvl-yellow">de calidad cinematográfica.</span>
              </h3>
            </div>
            <div className="flex flex-wrap gap-2">
              {["Video Corporativo", "Identidad Visual", "Dirección de Arte", "Reels & TikToks", "UI/UX Design", "Sitios Web"].map(tag => (
          ...
          >
            ...
            <div className="relative z-10">
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-gvl-orange mb-2 block">Branding & Estrategia</span>
              <h3 className="text-3xl font-black leading-tight text-black">
                Identidades <br />
                <span className="text-gvl-orange">inmemorables.</span>
              </h3>
            </div>
          ...
          >
            ...
            <div className="relative z-10">
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-600 mb-2 block">Cine & Comercial</span>
              <h3 className="text-3xl font-black leading-tight text-black">
                Contamos historias <br />
                <span className="text-blue-500">que venden</span>
              </h3>
            </div>
          ...
          >
            ...
            <div className="relative z-10">
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-gvl-yellow/60 mb-2 block">Experiencias Digitales</span>
              <h3 className="text-3xl font-black leading-tight text-white">
                Webs con <br />
                <span className="text-gvl-yellow">dirección de arte</span>
              </h3>
            </div>

            <div className="relative z-10 flex items-center justify-between">
              <p className="text-xs text-gray-400 max-w-[150px]">
                Portafolios, e-commerce y sitios premium.
              </p>
